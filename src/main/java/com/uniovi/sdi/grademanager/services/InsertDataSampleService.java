...
public class InsertDataSampleService {
    ...
    @PostConstruct
    public void init() {
        User user1 = new User("99999990A", "Pedro", "Diaz");
        User user2 = new User("99999991B", "Lucas", "Nunez");
        User user3 = new User("99999992C", "Maria", "Rodriguez");
        User user4 = new User("99999993D", "Marta", "Almonte");
        User user5 = new User("99999977E", "Pelayo", "Valdez");
        User user6 = new User("99999988F", "Edward", "Nunez");
